...
export class FraisunitListComponent implements OnInit, OnChanges {
  ...
  private columnDefinitions = [
      { def: 'codetypefrais', showMobile: true, display:'none', index:0},
      { def: 'idcontrat', showMobile: true, display:'none', index:1},
      { def: 'montantht', showMobile: true, display:'none', index:2},
      { def: 'tva1', showMobile: true, display:'none', index:3},
      { def: 'tva2', showMobile: true, display:'none', index:4},
      { def: 'tva3', showMobile: true, display:'none', index:5},
      { def: 'recu', showMobile: true, display:'none', index:6},
      { def: 'commentaire', showMobile: true, display:'none', index:7},
      { def: 'refact', showMobile: true, display:'none', index:8},
      { def: 'fraisunitid', showMobile: true, display:'table-cell', index:9},
      { def: 'idconsultant', showMobile: true, display:'table-cell', index:10},
      { def: 'codeperiode', showMobile: true, display:'table-cell', index:11},
      { def: 'datecalendrier', showMobile: true, display:'table-cell', index:12},
	];
