...
export class ListeListComponent implements OnInit, OnChanges {
  ...
  private columnDefinitions = [
      { def: 'nomliste', showMobile: true, display:'table-cell', index:0},
      { def: 'codeelement', showMobile: true, display:'table-cell', index:1},
      { def: 'nomelement', showMobile: true, display:'table-cell', index:2},
      { def: 'ordretri', showMobile: true, display:'table-cell', index:3},
      { def: 'image', showMobile: true, display:'table-cell', index:4},
      { def: 'defaut', showMobile: true, display:'table-cell', index:5},
	];
