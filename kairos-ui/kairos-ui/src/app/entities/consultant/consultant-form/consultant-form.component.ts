...
export class ConsultantFormComponent implements OnInit {
  ...
  update = () => {
    this._consultantService.update(<Consultant>this.form.getRawValue()/*, this.ids*/ ).subscribe(
  ...
  deleteConfirmation = () => {
    if (this.consultant.consultantid) {
      ...
      dialogRef.afterClosed().subscribe(result => {
        if (result) {
          this.deleteBadge(this.consultant.consultantid);
        }
      });
    }
  }

  deleteBadge = (consultantid): void => {
    // Call delete service
