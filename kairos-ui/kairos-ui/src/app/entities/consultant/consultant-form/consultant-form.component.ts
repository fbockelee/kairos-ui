// File generated by Telosys Tools Generator ( version 3.1.2 ) - Date 2020-04-20 ( Time 16:36:36 )
...
export class ConsultantFormComponent extends Lov implements OnInit {
  ...
  // Définition des LOV
  public listOfSOCIETE_itm: SelectItem[];
  ...
  initForm = () => {
	...
	/* Chargement des LOVs */
	this.getLOV ('SOCIETE').then(data_itm => {
		this.listOfSOCIETE_itm = data_itm; 
	});
  }
