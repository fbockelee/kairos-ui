// File generated by Telosys Tools Generator ( version 3.1.2 ) - Date 2020-04-28 ( Time 12:07:20 )
...
export class CalendrierListComponent implements OnInit, OnChanges {
  ...
  private columnDefinitions = [
      { def: 'codeperiode', showMobile: true, display:'table-cell', index:0},
      { def: 'datecalendrier', showMobile: true, display:'table-cell', index:1},
      { def: 'ferie', showMobile: true, display:'table-cell', index:2},
	];
