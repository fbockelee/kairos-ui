...
export class FournisseurListComponent implements OnInit, OnChanges {
  ...
  private columnDefinitions = [
      ...
      { def: 'contratfournisseur', showMobile: true, display:'none', index:7},
      { def: 'fournisseurid', showMobile: true, display:'table-cell', index:8},
      { def: 'trigramme', showMobile: true, display:'table-cell', index:9},
      { def: 'raisonsociale', showMobile: true, display:'table-cell', index:10},
      { def: 'contact1', showMobile: true, display:'table-cell', index:11},
      { def: 'tel1_portable', showMobile: true, display:'table-cell', index:12},
      { def: 'tel1_travail', showMobile: true, display:'table-cell', index:13},
	];
